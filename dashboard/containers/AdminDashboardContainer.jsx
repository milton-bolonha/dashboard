...
export function AdminDashboardContainer() {
  try {
    ...
    const persistTileAndRefresh = useCallback(
      async (payload) => {
        ...
        const normalizedTile = {
          id:
            tileFromPayload?.id || `tile_${jobIdFromUrl}_${payload.orderIndex}`,
    ...
    console.error(
      "❌ [AdminDashboardContainer] Erro catastrófico durante a renderização inicial:",
      e
    );
    // Renderiza uma UI de erro simples para não quebrar a tela toda
    return (
      <div className="min-h-screen flex items-center justify-center bg-red-50 text-red-800">
        <div className="text-center p-8 border border-red-200 rounded-lg">
          <h1 className="text-2xl font-bold mb-2">Erro Crítico</h1>
          <p>Ocorreu um erro ao carregar o dashboard.</p>
          <p className="mt-4 text-sm font-mono bg-red-100 p-2 rounded">
