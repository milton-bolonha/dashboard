...
> 📊 **Para detalhes completos do status de implementação**, consulte [`docs/STATUS-IMPLEMENTACAO.md`](./STATUS-IMPLEMENTACAO.md).
...
Todos os documentos estão organizados em `docs/`. Veja [`docs/README.md`](./README.md) para o índice completo.

**Documentação Principal**:

- [`docs/README.md`](./README.md) — Índice principal da documentação
- [`docs/novo-fluxo.md`](./novo-fluxo.md) — Fluxo operacional atualizado (Nov/2025)
- [`docs/fluxo-tiles.md`](./fluxo-tiles.md) — Fluxo de criação de tiles e engenharia de prompts
- [`docs/README-admin.md`](./README-admin.md) — Anatomia detalhada dos temas (Ade, Classic, Dash)
- [`docs/generic.md`](./generic.md) — Blueprint completo de arquitetura
- [`docs/prompt-fluxo.md`](./prompt-fluxo.md) — Sistema de visualização de arquitetura
- [`docs/CHECKLIST-ADMIN.md`](./CHECKLIST-ADMIN.md) — Checklist do Admin
- [`docs/plano-finalizar-14-11.md`](./plano-finalizar-14-11.md) — Plano de finalização
